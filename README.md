...
<br>
<p>The <strong>y value</strong> in the plot represents the relative effect of vaccination on the death rate between the vaccinated (vx) and unvaccinated (uvx) groups.</p>
<ul>
  <li><strong>Positive y value:</strong> The death rate is higher in the vaccinated group than in the unvaccinated group.</li>
  <li><strong>Negative y value:</strong> The death rate is higher in the unvaccinated group than in the vaccinated group.</li>
  <li><strong>y = 0:</strong> Death rates are equal (HR = 1), meaning no observed effect as in the simulated placebo dataset, but without the bias introduced by constraint "death day > last dose day</li>
</ul>
